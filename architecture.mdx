...
flowchart TB
    subgraph CP["Control plane"]
        direction LR
        ORCH["Branch orchestration"] --- ROUTE["Connection routing"] --- HEALTH["Health and WAL monitoring"] --- POL["Policies and auth"]
    end
    subgraph DP["Data plane"]
        direction LR
        PROD[("Your<br/>production DB")] -->|logical replication| AR["Ardent Replicator<br/>+ Kafka pipeline"]
        AR --> REP[("Read<br/>replica")]
