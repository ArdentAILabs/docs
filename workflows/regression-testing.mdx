...
Most test runners read the database from `DATABASE_URL` — Django, SQLAlchemy, Prisma, and most pytest setups already do. If yours uses a different variable or a `.env` file, substitute that below.
