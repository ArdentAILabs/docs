...
<Accordion defaultOpen={false} title="Permanent AI skill: install with npx">
...
<Accordion defaultOpen={false} title="Permanent AI skill: manual SKILL.md and CLAUDE.md">
