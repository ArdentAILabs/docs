...
## Install the ardent-cli skill

Point your agent at Ardent once, and every later task can use it:

<AccordionGroup>
<Accordion defaultOpen={false} title="Install with npx">

If your agents touch the database every day, install this as a skill instead of pasting per task. Once installed, Claude Code loads it automatically whenever a task involves Ardent.

Install with the [skills CLI](https://skills.sh) — it works for Claude Code, Cursor, and other agents, and asks where to install:
...
<Accordion defaultOpen={false} title="Manual install: SKILL.md and CLAUDE.md">
