...
- `ARDENT_TOKEN` authenticates the CLI without writing an interactive login session or interpolating the secret into a shell command. It is scoped only to the Ardent CLI steps, not the test step.
