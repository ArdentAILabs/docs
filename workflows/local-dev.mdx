...
A branch takes 6 seconds, and on it you can run any migration, drop any table, try any index. If it breaks, delete the branch and start over. Your production data is never at risk.
