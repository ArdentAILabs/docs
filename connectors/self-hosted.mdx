...
3. wal_level is logical, max_wal_senders and max_replication_slots are high enough, and at least one replication slot is free.
...
-- Use at least 10, but do not lower an existing higher value.
