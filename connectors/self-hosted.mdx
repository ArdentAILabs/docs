...
<Step title="Allow inbound from Ardent" id="allow-inbound-from-ardent">
...
<Step title="Install the wal2json output plugin" id="install-the-wal2json-output-plugin">
...
<Step title="Create the Ardent role" id="create-the-ardent-role">
...
<Step title="Run preflight until it passes" id="run-preflight-until-it-passes">
