...
<Tip>
**Rather have Claude set this up?** Copy this into Claude Code or Cursor:

```
I want to set up Ardent for database branching.
Install ardent-cli, log in, connect my Postgres
database [paste connection string], and create my
first branch. Docs: https://docs.tryardent.com
```
</Tip>
