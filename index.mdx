...
```
I want to set up Ardent. Install ardent-cli, log in, connect my Postgres database, and create my first branch. My connection string: [paste here]. Docs: https://docs.tryardent.com
```
</Tip>
