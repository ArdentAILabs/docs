...
<Accordion defaultOpen={false} title="Using Claude Code or Cursor? It can set Ardent up for you">
With the [ardent-cli skill](/workflows/ai-agents#let-the-agent-drive-set-it-up-once) installed, a short ask is enough — the skill fetches the current docs and works through setup:
