...
<Tip>
**Rather have Claude do it?** Copy this into Claude Code or Cursor:

```
I want to set up Ardent for database branching. Help me:
1. Install the CLI: npm install -g ardent-cli
2. Log in: ardent login
3. Connect my database and create my first branch

My Postgres connection string is: [paste yours here]
