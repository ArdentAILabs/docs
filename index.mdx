...
<Accordion title="Rather have Claude set this up?">
Copy this into Claude Code or Cursor:

```
I want to set up Ardent for database branching. Help me install the CLI (npm install -g ardent-cli), log in, connect my database, and create my first branch. My Postgres connection string is: [paste yours here]. Docs: https://docs.tryardent.com
```
</Accordion>
