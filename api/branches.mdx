...
For branch connections, set SQL clients and IDEs to SSL mode `require` and leave custom root certificate, CA bundle, SSL certificate authority, or `sslrootcert` fields blank. Do not reuse a source database CA bundle; it cannot verify the branch routing host and can cause TLS errors.
