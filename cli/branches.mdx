...
If branch creation times out, it may still be running server-side. Re-run the same command to resume, or check `ardent branch list`. The timeout error includes an operation ID for support:
