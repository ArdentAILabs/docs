...
Use positive poll intervals for both create and delete. The two commands do not validate invalid overrides the same way today; the table above documents the current behavior.
