...
| Variable | Use it for |
| --- | --- |
| `ARDENT_TOKEN` | Authenticate in CI or other headless environments without running `ardent login` |
| `ARDENT_API_URL` | Override the API endpoint. Defaults to `https://api.tryardent.com` |
